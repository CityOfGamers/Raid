...
[CreateAssetMenu(fileName = "Ability_RaiderRifle", menuName = "FPS Sample/Abilities/Ability_RaiderRifle")]
public class Ability_RaiderRifle : CharBehaviorFactory
{
	public enum State
	{
		Idle,
...
[DisableAutoCreation]
class RaiderRifle_RequestActive : BaseComponentDataSystem<CharBehaviour,AbilityControl,Ability_AutoRifle.PredictedState,Ability_AutoRifle.Settings>
{
	public RaiderRifle_RequestActive(GameWorld world) : base(world)
	{
...
[DisableAutoCreation]
class RaiderRifle_Update : BaseComponentDataSystem<CharBehaviour,AbilityControl,Ability_AutoRifle.PredictedState,Ability_AutoRifle.Settings>
{
	public RaiderRifle_Update(GameWorld world) : base(world)
	{
		ExtraComponentRequirements = new ComponentType[] { typeof(ServerEntity) } ;
	}
...
[DisableAutoCreation]
class RaiderRifle_HandleCollisionQuery : BaseComponentDataSystem<Ability_AutoRifle.InternalState,Ability_AutoRifle.InterpolatedState>
{
	public RaiderRifle_HandleCollisionQuery(GameWorld world) : base(world)
	{
		ExtraComponentRequirements = new ComponentType[] { typeof(ServerEntity) } ;
	}
