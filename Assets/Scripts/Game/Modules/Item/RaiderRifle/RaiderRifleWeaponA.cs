...
[ClientOnlyComponent]
public class RaiderRifleWeaponA : MonoBehaviour
{
...
// System
[DisableAutoCreation]
public class UpdateRaiderRifleWeaponA : BaseComponentSystem<CharacterPresentationSetup,TerraformerWeaponA>
{
    public UpdateRaiderRifleWeaponA(GameWorld world) : base(world)
    {
...
[DisableAutoCreation]
public class RaiderRifleWeaponAClientProjectileSpawnHandler : InitializeComponentGroupSystem<ClientProjectile, TerraformerWeaponClientProjectileSpawnHandler.Initialized>
{
    public struct Initialized : IComponentData {}
    
    private ComponentGroup WeaponGroup;
    
    public RaiderRifleWeaponAClientProjectileSpawnHandler(GameWorld world) : base(world)
    {}
