        ...
        void LateUpdate()
        {
            ...
            if (player != null)
            {
                if (player.position.y >= m_sealevel)
                {
                    ...
                    {
                        StopAllCoroutines();
                        UnityEngine.RenderSettings.fogColor = storedFogColor;
                        UnityEngine.RenderSettings.fogEndDistance = storedFogDistance;
                        indexNumber = 0;
                        mainlight.cookie = null;
                ...
                if (player.position.y < m_sealevel)
                {
                    if (!coroutineStatus)
                    {
                        ...
                        UnityEngine.RenderSettings.fogColor = m_underWaterFogColor;
                        UnityEngine.RenderSettings.fogEndDistance = m_underWaterFogDistance;
