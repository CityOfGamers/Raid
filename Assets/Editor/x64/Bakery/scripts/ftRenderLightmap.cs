...
public class ftRenderLightmap : EditorWindow//ScriptableWizard
{
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(10, y, 230, 30), "Update Skybox Probe"))
        {
            ...
            UnityEngine.RenderSettings.customReflection = AssetDatabase.LoadAssetAtPath(outName, typeof(Cubemap)) as Cubemap;
    ...
    IEnumerator RenderLightProbesFunc()
    {
        ...
        Material origSkybox = UnityEngine.RenderSettings.skybox;
        Material tempSkybox;
        ...
        //if (!useUnityForLightProbes)
        {
            ...
            if (firstSkyLight != null)
            {
                ...
                tempSkybox.SetColor("_Tint", UnityEditor.PlayerSettings.colorSpace == ColorSpace.Linear ? firstSkyLight.color : firstSkyLight.color.linear);
            ...
            UnityEngine.RenderSettings.skybox = tempSkybox;
        ...
        if (probes == null)
        {
            ...
            UnityEngine.RenderSettings.skybox = origSkybox;
            //RestoreSceneManagerSetup(setup);
            DestroyImmediate(go);
            //userCanceled = true;
            //ProgressBarEnd();
        ...
        mat.SetFloat("gammaMode", UnityEditor.PlayerSettings.colorSpace == ColorSpace.Linear ? 0 : 1);
